component persistent="true" table="carts" extends="AbstractEntity" {
	...
	property name="items" fieldtype="one-to-many" cfc="Cartitem" 
		singularname="item" type="array" fkcolumn="cartid" inverse="true" lazy="false"
		fetch="join";
	...
	Array function getItemNames() {
		var items = getItems();
		var names = items.each(function (i) {
